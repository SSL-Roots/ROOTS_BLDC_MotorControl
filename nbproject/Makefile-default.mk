...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c BLDC_Drive_Control.c initialize.c MotorDriverStatus.c config_can.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/BLDC_Drive_Control.o ${OBJECTDIR}/initialize.o ${OBJECTDIR}/MotorDriverStatus.o ${OBJECTDIR}/config_can.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/BLDC_Drive_Control.o.d ${OBJECTDIR}/initialize.o.d ${OBJECTDIR}/MotorDriverStatus.o.d ${OBJECTDIR}/config_can.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/BLDC_Drive_Control.o ${OBJECTDIR}/initialize.o ${OBJECTDIR}/MotorDriverStatus.o ${OBJECTDIR}/config_can.o

# Source Files
SOURCEFILES=main.c BLDC_Drive_Control.c initialize.c MotorDriverStatus.c config_can.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/config_can.o: config_can.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  config_can.c  -o ${OBJECTDIR}/config_can.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/config_can.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/config_can.o: config_can.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/config_can.o.d 
	@${RM} ${OBJECTDIR}/config_can.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  config_can.c  -o ${OBJECTDIR}/config_can.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/config_can.o.d"      -mno-eds-warn  -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/config_can.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf  -mreserve=data@0x1000:0x101B -mreserve=data@0x101C:0x101D -mreserve=data@0x101E:0x101F -mreserve=data@0x1020:0x1021 -mreserve=data@0x1022:0x1023 -mreserve=data@0x1024:0x1027 -mreserve=data@0x1028:0x104F   -Wl,--local-stack,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}/xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/ROOTS_BLDC_MotorControl.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
